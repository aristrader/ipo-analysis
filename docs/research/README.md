...
What lives here:
- **The live to-do menu:** `improvement_backlog.md` (OPEN items only; done → git log + `rules/index.md`).
...
- Open WORK lives ONLY in `improvement_backlog.md`. Every signal's verdict lives in `rules/index.md`. History → git log.
