...
*Consolidated 2026-06-17. This file + `FOUNDATION_ARCHITECTURE.md` are the ONLY two design docs now;
everything else from the design run was folded in here and deleted.*
...
## 6. INPUTS / SUPPORTING ARTIFACTS
- `FOUNDATION_ARCHITECTURE.md` — the design reference (layers, tables, yaml, what-runs-what, the CR-* issue build-spec).
- `splits_findings.md` — background corp-action/split research (feeds the Phase-5 deep-dive). *(generated by a background agy agent)*
