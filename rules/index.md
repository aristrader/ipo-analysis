...
| wipeout red-flags (tiny-sales, loss-making, obscure-banker) | **DISPLAY (badge)** — score-candidate | validated as descriptive cross-regime flags (N14); OOS-into-downside-score test pending before any weight. **obscure-banker sub-definition redefined 2026-06-09 (A1) — see below.** |
